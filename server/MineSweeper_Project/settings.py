"""
Django settings for MineSweeper_Project project.
...
SECRET_KEY = os.environ['MINSWIP_SECRET_KEY']
...
INSTALLED_APPS = [
    ...
    # To install all config of app
    'app.apps.AppConfig',
    # To install all config of plugin "social_django"
    'social_django',
]
...
WSGI_APPLICATION = 'MineSweeper_Project.wsgi.application'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    # This is a path of your pipeline.py and get_avatar is the function.
